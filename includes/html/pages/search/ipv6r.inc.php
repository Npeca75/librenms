<div class="panel panel-default panel-condensed">
    <div class="panel-heading">
        <strong>IPv6 Routes</strong>
    </div>
    <table id="iproute-search" class="table table-hover table-condensed table-striped">
        <thead>
            <tr>
...
var grid = $("#iproute-search").bootgrid({
    ajax: true,
...
$query = 'SELECT `devices`.`device_id`,`hostname`,`sysName`,`display` FROM `devices`';
$param = [];
...
?>
                  ...
                  "</div>&nbsp;"+
                  "<div class=\"form-group\">"+
                  "<input type=\"text\" name=\"route\" id=\"route\" size=40 value=\"<?php echo $_POST['route']; ?>\" class=\"form-control input-sm\" placeholder=\"IPv6 route\"/>"+
                  "</div>&nbsp;"+
